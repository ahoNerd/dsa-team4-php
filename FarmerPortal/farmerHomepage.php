      ...
      <body>
           ...
           <nav class="navbar navbar-expand-xl ">
                ...
                <div class=" flex-row-reverse left ">
                    ...
                    <a href="CartPage.php"> <i class="fa" style=" color:green ;font-size:20px;margin-top:-20px;margin-bottom:20px;">&#61562;</i></a> -->
                     ...
                     <a class="float-left" href="#">
                          <img src="agro.png?v=1" class="float-left mr-5 ml-0 " alt="Logo" style="height:50px;">
                     </a>
                </div>
                ...
                <a class="float-left" href="farmerHomepage.php">
                     <img src="agro.png?v=1" class="float-left mr-2 moblogo" alt="Logo" style="height:50px;">
                </a>
                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                     <div class="carousel-inner">
                          <div class="carousel-item active">
                               <img class="d-block w-100 resizing" src="../Images/Homepage/fruitsbasket.jpg?v=1" alt="First slide">
                          </div>
                          <div class="carousel-item">
                               <img class="d-block w-100 resizing" src="../Images/Homepage/farm.jpg" alt="Third slide">
                          </div>
                          <div class="carousel-item">
           ...
           <div class="features container">
                ...
                <div class="card-deck row text-center" style="display: flex; flex-wrap: wrap;">
                     ...
                     <div class="card">
                          <p class="aligncenter">
                               <img class="card-img-top image" src="../Images/Homepage/farmer.jpg" alt="Card image cap" width="250px" height="200px">
                          </p>
                          <div class="card-body">
